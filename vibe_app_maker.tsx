        ...
        <div className={`${GlassTheme.glass} rounded-xl p-6 min-h-96`}>
          ...
          <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg p-8 min-h-80">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-purple-900 mb-4">Your {appConfig.theme} App</h2>
              <p className="text-purple-700 mb-6">{appConfig.idea}</p>
...
export default function VibeAppMaker() {
  ...
  const handleDownload = () => {
    ...
    const projectStructure = {
      ...
      'devbox.json': { /* devbox.json content */ },
      'src/index.tsx': '// Generated Hono server',
      'src/App.tsx': '// Generated React app',
      // ... other files
    };
